        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
          <div className="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
            <Form className="space-y-6" onSubmit={onSubmit}>
              ...
              <Label name="Email address" className="label block text-sm font-medium leading-6 text-gray-900" errorClassName="label error" />
              <TextField
                name="email"
              ...
              />
              <FieldError name="password" className="error-message block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
