...
const ActionsPage = () => {
  ...
  const addKeyResult = () => {
    ...
    return (
      ...
      <div className="mb-8">
          <h2 className="text-xs font-semibold text-gray-600 uppercase tracking-wide">Actions</h2>
                        ...
                        {/* {newMessage.map((person, v) => ( */}
                          ...
                          <tr>
                            ...
                            <Link
                              ...
                              >
                                Conduct a literature review on the chosen research topic<span className="sr-only">, {}</span>
                              </Link>
                            </td>
  
  
  
                            <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{"02-01-2023"}</td>
