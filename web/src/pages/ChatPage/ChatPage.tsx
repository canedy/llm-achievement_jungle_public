          ...
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            <div className="mx-auto grid max-w-2xl grid-cols-1 grid-rows-1 items-start gap-x-8 gap-y-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
              ...
              <div className="lg:col-start-3 lg:row-end-1">
                ...
                <div className="rounded-lg bg-blue-100 shadow-sm ring-1 ring-gray-900/5">
                  {/* <dl className="flex flex-wrap"> */}
                    ...
                    <div className="mt-4 flex w-full flex-none gap-x-4 px-6">
                      ...
                      <span className="text-sm leading-6 text-gray-500 py-4">🏆Show some appreciation</span>
                    </div>
                ...
                <div className="rounded-lg bg-blue-100 shadow-sm ring-1 ring-gray-900/5">
                  {/* <dl> */}
                    <div className="mt-4 flex w-full flex-none gap-x-4 px-6">
                      <span className="text-sm leading-6 text-gray-500 py-4">Top 3 🔥 actions</span>
                    </div>
                  {/* </dl> */}
                </div>
              </div>
